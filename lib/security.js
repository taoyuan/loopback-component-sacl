...
class Security {
	...
	constructor(app, options) {
		...
		// load groups models
		this.groups = _(groupModels).map(owner => this.app.registry.getModel(owner)).uniq().value();

		// load resources models
		this.resources = _(this.app.models).filter(modelClass => {
		...
		this.models = _.uniq(_.union(this.groups, this.resources));
	}
